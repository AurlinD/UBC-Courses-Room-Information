...
var QueryValidation = (function () {
    function QueryValidation() {
    }
    QueryValidation.validateQuery = function (query) {
    ...
    QueryValidation.checkForValidFilter = function (query, key) {
    ...
    QueryValidation.checkForValidColumnsAndOrder = function (query, key, ApplyList, GroupList) {
            ...
            if (o == "ORDER") {
                ...
                if (typeof order == "string") {
                    if (columnsResult.includes(order)) {
                        ...
                        orderIsValid = QueryValidation.checkForValidOrder(query, order, ApplyList);
                    }
                }
            }
        }
    ...
    QueryValidation.checkForOrderKeyWord = function (query, order, ApplyList, GroupList) {
        var hasSkey = false;
        var hasMkey = false;
    ...
    QueryValidation.getOrderNewKeyword = function (query, key, ApplyList, GroupList) {
        var hasValidKeys = true;
        var orderIsValid = true;
        var options = query[key];
        var columnsResult;
    ...
    QueryValidation.checkforValidTransformation = function (query, ApplyList, GroupList, accessTransformation) {
    ...
    QueryValidation.checkforValidGroup = function (query, group, GroupList) {
        var hasSkey = true;
        var hasMkey = true;
    ...
    QueryValidation.checkforValidApply = function (query, apply, ApplyList) {
    ...
    QueryValidation.checkForValidKeys = function (query, columns, applyList) {
        var hasSkey = true;
        var hasMkey = true;
    ...
    QueryValidation.checkForNewKeys = function (query, columns, ApplyList, GroupList) {
        var hasSkey = true;
        var hasMkey = true;
        var validKeySoFar = true;
    ...
    QueryValidation.checkForValidOrder = function (query, order, applyList) {
        var hasSkey = false;
        var hasMkey = false;
        var hasApplyKey = false;
    ...
    QueryValidation.applyToken = function (check) {
    ...
    QueryValidation.hasDir = function (check) {
    ...
    QueryValidation.hasMkeys = function (check) {
    ...
    QueryValidation.hasSkeys = function (check) {
    ...
    QueryValidation.isValidMcComparision = function (filterObject, filter) {
        var that = this;
    ...
    QueryValidation.isValidScComparision = function (filterObject, filter) {
        var isValid = true;
        var isValidPrev = true;
        for (var prop in filterObject) {
    ...
    QueryValidation.isValidNegation = function (filterObject, filter) {
        var isValid = true;
        for (var prop in filterObject) {
    ...
    QueryValidation.isValidLogicComparision = function (logicArray, filter) {
        var isValid = true;
    ...
    QueryValidation.isValidFilter = function (query, filter) {
        var isValid = false;
